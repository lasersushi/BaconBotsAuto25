...
public class PedroAutoRed extends OpMode {
    ...
    private void buildPaths() {
        Start = new Path(new BezierLine(new Pose(56, 8.000), new Pose(56.000, 36.000)));
        Start.setConstantHeadingInterpolation(Math.toRadians(90));
